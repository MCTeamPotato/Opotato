...
public class NecConfig {
    ...
    public static class CrashUpload {
        public final CrashLogUploadDestination destination = CrashLogUploadDestination.BYTEBIN;
        public final String hasteUrl = "https://hastebin.com/";
        public final String bytebinUrl = "https://bytebin.lucko.me/";
        public final Gist gist = new Gist();
        public final Pastebin pastebin = new Pastebin();
    ...
    public static class Gist {
        ...
        public final boolean unlisted = false;
    }
    ...
    public static class Pastebin {
        ...
        public final Privacy privacy = Privacy.PUBLIC;
        public final Expiry expiry = Expiry.NEVER;
    }
    ...
    private static final File CONFIG_FILE = new File(NecPlatform.instance().getConfigDirectory().toFile(), Opotato.ID + "_nec.json");
