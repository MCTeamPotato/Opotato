...
public class PotatoCommonConfig {
    ...
    static {
        ...
        CONFIG_BUILDER.comment("Every settings here will improve performance a lot as the mod is really laggy");
